...
function InitializeGameUI() {
    ...
    gameUILibrary.AddUIElements({
        ...
        "ui-main-button1": {transform:{left:'33.1%', top:'34.78%', width:'33.8%', height:'9.36%'}, button:{imgSrc:"img/gameCommon/button.png", round:10, fontFamily:'CustomFont', fontSize:42, letterSpacing:4, color:'white', text:'', onclick:()=>{OnClickUIButton(1);}}},
        "ui-main-button2": {transform:{left:'33.1%', top:'45.25%', width:'33.8%', height:'9.36%'}, button:{imgSrc:"img/gameCommon/button.png", round:10, fontFamily:'CustomFont', fontSize:42, letterSpacing:4, color:'white', text:'', onclick:()=>{OnClickUIButton(2);}}},
        "ui-main-button3": {transform:{left:'33.1%', top:'55.72%', width:'33.8%', height:'9.36%'}, button:{imgSrc:"img/gameCommon/button.png", round:10, fontFamily:'CustomFont', fontSize:42, letterSpacing:4, color:'white', text:'', onclick:()=>{OnClickUIButton(3);}}},
        "ui-main-button4": {transform:{left:'33.1%', top:'66.19%', width:'33.8%', height:'9.36%'}, button:{imgSrc:"img/gameCommon/button.png", round:10, fontFamily:'CustomFont', fontSize:42, letterSpacing:4, color:'white', text:'', onclick:()=>{OnClickUIButton(4);}}},
