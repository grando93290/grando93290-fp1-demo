...
function InitializeGameUI() {
    ...
    gameUILibrary.AddUIElements({
        ...
        "ui-question-ballon": {transform:{left: '46.22%', top:'0', width: '7.54%', height:'9.55%'}, ballon:{imgSrc:"img/gameCommon/greenBallon.png", fontFamily:'CustomFont', fontSize:34, letterSpacing:4, color:'white', text:'0'}},
        "ui-playera-ballon": {transform:{left: '27.71%', top:'0', width: '18.51%', height:'9.55%'}, image:{imgSrc:"img/game5ui/ballon.png"}},
        "ui-playera-ballon-text": {transform:{left: '33.96%', top:'3.2%', width: '5.09%', height:'3%'}, image:{imgSrc:"img/game5ui/playera-text.png"}},
        "ui-playera-ballon-score": {transform:{left: '29.5%', top:'2.22%', width: '3.29%', height:'5.11%'}, ballon:{imgSrc:"img/game5ui/heart.png", fontFamily:'CustomFont', fontSize:25, letterSpacing:4, color:'white', text:'0'}},
        "ui-playera-ballon-icon": {transform:{left: '40.1%', top:'0.6%', width: '4.05%', height:'7.78%'}, image:{imgSrc:"img/game5ui/playera-icon.png"}},
        "ui-playera-ballon-arrow": {transform:{left: '45.38%', top:'2.78%', width: '1.73%', height:'3.33%'}, image:{imgSrc:"img/game5ui/arrow.png"}},
        "ui-playerb-ballon": {transform:{left: '53.76%', top:'0', width: '18.51%', height:'9.55%'}, image:{imgSrc:"img/game5ui/ballon.png"}},
        "ui-playerb-ballon-text": {transform:{left: '60.96%', top:'3.2%', width: '5.09%', height:'3%'}, image:{imgSrc:"img/game5ui/playerb-text.png"}},
        "ui-playerb-ballon-score": {transform:{left: '67.19%', top:'2.22%', width: '3.29%', height:'5.11%'}, ballon:{imgSrc:"img/game5ui/heart.png", fontFamily:'CustomFont', fontSize:25, letterSpacing:4, color:'white', text:'0'}},
        "ui-playerb-ballon-icon": {transform:{left: '55.7%', top:'0.6%', width: '4.05%', height:'7.78%'}, image:{imgSrc:"img/game5ui/playerb-icon.png"}},
        "ui-playerb-ballon-arrow": {transform:{left: '52.89%', top:'2.78%', width: '1.73%', height:'3.33%'}, image:{imgSrc:"img/game5ui/arrow2.png"}},
        ...
        "ui-main-no-winner": {transform:{left:'41.29%', top:'31.5%', width:'17.41%', height:'6.67%'}, image:{imgSrc:"img/game5ui/no-win.png"}},
        ...
        "ui-bg": {transform:{left:'0%', top:'0%', width:'100%', height:'100%'}, image:{imgSrc:"img/game5ui/2.png"}},
    });
    ...
    gamePlayerABallon_score.AddCoveredBallon({imgSrc2:"img/game5ui/heart2.png"});
    ...
    gamePlayerBBallon_score.AddCoveredBallon({imgSrc2:"img/game5ui/heart2.png"});
